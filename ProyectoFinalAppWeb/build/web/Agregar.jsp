                ...
                <div class="publication">
                    <section class="publication-container">
                        <div class="message-container">
                            <ul class="edits">
                                <li><input id="tituloPost" type="text" placeholder="Título" name="titulo" required="required" /></li>
                            ...
                            <input id="contenidoPost" class="edit-cuerpo" type="text" placeholder="Cuerpo" name="contenido" required="required" />
                        </div>
                    </section>
                </div>
            </div>
            <button id="btnSubmitPost" type="submit" class="btnGreen">Agregar Publicación</button>
        </form>
